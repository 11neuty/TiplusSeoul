...
public class Shop {
	...
	def static void addToCartWithGlobalVariable(){
		addToCart(GlobalVariable.productName,GlobalVariable.baseUrlProduct)
	}

	@Keyword
	def static void applyCouponAndAddToCartWithGlobalVariable(){
		applyCouponAndAddToCart(GlobalVariable.productName, GlobalVariable.baseUrlProduct, GlobalVariable.coupon)
	}
}
