...
TestObject myElement = findTestObject('Object Repository/verificationElemen/application')
...
WebUI.doubleClick(findTestObject('Object Repository/Page2/ChooseSeoul'))
